...
public class Fornecedor {
    ...
    private String uf;
    private String cep;    
    private List<ContatoFornecedor> contatoFornecedor;
     ...
     */
    public List<ContatoFornecedor> getContatoFornecedor() {
     ...
     */
    public void setContatoFornecedor(List<ContatoFornecedor> contatoFornecedor) {
